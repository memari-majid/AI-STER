...
echo "🔧 Fixing ngrok domain issue for AI-STER..."
echo ""
...
echo "   - Install: curl -L https://github.com/cloudflare/cloudflared/releases/latest/download/cloudflared-linux-amd64 -o cloudflared"
echo "   - Make executable: chmod +x cloudflared"
echo "   - Run tunnel: ./cloudflared tunnel --url http://localhost:8501"
echo ""
echo "Current status:"
